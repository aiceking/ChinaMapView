...
* [使用](#使用)
    ...
    * [代码中修改Data和View属性](#代码中通过ChinaMapView的getChinaMapModel()方法拿到ChinaMapModel通过修改ChinaMapModel的属性来刷新ChinaMapView的显示效果其他的缩放倍数和接口通过ChinaMapView直接设置Demo中的SwipRefreshAppbarActivity和NormalActivity中有详细使用代码)
